# CLAUDE.md — `dekuraan/winit` fork (branch `wam-0.30.13`)
...
If you find yourself wanting to add a wam-specific note here, it probably belongs in `wam/CLAUDE.md` or a wam-side memory entry instead. This file is for facts about *this fork's* relationship to upstream.
